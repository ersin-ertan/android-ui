...
public class ViewStoryActivity extends BaseActivity{
	...
	@Bind(R.id.progress_indicator) LinearLayout   mProgressContainer;
	@Bind(R.id.layout_offline)     LinearLayout   mOfflineLayout;
	@Bind(R.id.layout_story)       RelativeLayout mStoryLayout;
