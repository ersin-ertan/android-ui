...
public class ConcreteViewModel extends ViewModelBase{ // implements Parcelable in base class
	...
	public static final Creator<ConcreteViewModel> CREATOR = new Creator<ConcreteViewModel>() {
		public ConcreteViewModel createFromParcel(Parcel source) {
			...
			com.nullcognition.googledatabinding01.view.viewmodel.ConcreteViewModelParcelablePlease.readFromParcel(
					target, source);
			return target;
		}

		public ConcreteViewModel[] newArray(int size) {
			return new ConcreteViewModel[size];
		}
	};
	String                      firstName;
	String                      lastName;
